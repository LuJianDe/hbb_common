...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".into(), "Luhao.frank714".into());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["149.104.2.26"];
pub const RS_PUB_KEY: &str = "C64WOVg4gDsLOkFXNQXjxEgsD41L5+xGz7b0gcxHJrc=";
